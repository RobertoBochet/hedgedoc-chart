...
| `hedgedoc.config.db.username`                  | Username used to authenticate to the database                                                                                                                                                                                                                                          | `nil`        |
| `hedgedoc.config.db.password`                  | Password used to authenticate to the database                                                                                                                                                                                                                                          | `nil`        |
| `hedgedoc.config.db.database`                  | Name of the database used to store hedgedoc data                                                                                                                                                                                                                                       | `nil`        |
| `hedgedoc.config.db.host`                      | Hostname used to connect the database server                                                                                                                                                                                                                                           | `nil`        |
| `hedgedoc.config.db.port`                      | Port used to connect the database server                                                                                                                                                                                                                                               | `nil`        |
| `hedgedoc.config.db.dialect`                   | [Dialect](https://sequelize.org/v5/manual/dialects.html) / protocol used to connect to the database                                                                                                                                                                                    | `nil`        |
